    ...
    <div className="p-8 sm:p-10">
      <div className="relative mb-4">
        ...
        <div className="relative inline-flex items-center gap-2 rounded-xl bg-slate-900 text-white px-4 py-2 shadow-lg">
          <span className="text-sm font-semibold">COW-CAMPUS-CONNECT🎉</span>
        </div>
      </div>
      ...
      <div className="mt-4 inline-flex items-center gap-2 rounded-full text-xs text-white shadow-sm select-none cursor-default">
        <span
          className={`${igGradient} inline-flex items-center gap-2 rounded-full px-3 py-1`}
        >
          Instagram을 통해 마음에 드는 사람에게 용기를 내어보세요!
        </span>
      </div>
    </div>
  );
